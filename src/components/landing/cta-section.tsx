            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
                <AnimatedContent>
                    <div className="max-w-md">
                        <h2 className="font-headline text-3xl font-bold tracking-tight sm:text-4xl">Ready to Launch Your Tech Career?</h2>
                        <p className="mt-4 text-lg text-primary-foreground/80">
                            Don't wait to build the future. Our next batch is starting soon. Enroll now and take the first step towards your dream job.
                        </p>
                    </div>
                </AnimatedContent>
